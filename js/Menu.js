class Menu extends Phaser.Scene {
  ...
  displayInstruction() {
    ...
    this.menuInstructionText = this.add.text(this.pageInset + this.pageMargin, 400, "Use the Arrow Keys to choose a game and press Space Bar to play it.", this.standardStyle);
  }
